...
<div class="container mt-5">
    ...
    <h1>Módulo editar producto</h1>
    <form action="<?php echo URL; ?>edit/EditProduct/<?php echo $data['data'][0]['id']; ?>" method="POST" class="mt-5">
        <input value="<?php echo $data['data'][0]['id']; ?>" type="hidden" class="form-control" id="id" name="id">
        <div class="mb-3">
            <label for="product_name" class="form-label">Nombre del producto</label>
            <input value="<?php echo $data['data'][0]['product_name']; ?>" type="text" class="form-control" id="product_name" name="product_name" required>
        </div>
        <div class="mb-3">
            <label for="reference" class="form-label">SKU/Referencia</label>
            <input value="<?php echo $data['data'][0]['reference']; ?>" type="text" class="form-control" id="reference" name="reference" required>
        </div>
        <div class="mb-3">
            <label for="price" class="form-label">Precio de venta</label>
            <input value="<?php echo $data['data'][0]['price']; ?>" type="number" class="form-control" id="price" name="price" required>
        </div>
        <div class="mb-3">
            <label for="wegith" class="form-label">Peso en gramos</label>
            <input value="<?php echo $data['data'][0]['wegith']; ?>" type="number" class="form-control" id="wegith" name="wegith" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input value="<?php echo $data['data'][0]['stock']; ?>" type="number" class="form-control" id="stock" name="stock" required>
        </div>
